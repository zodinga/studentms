  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      ...
      @if(Auth::check())
          ...
          <li class="{{ Request::is('registrations')?"active":"" }}"><a href="{{route('registrations.index')}} ">Register</a></li>
          <li class="{{ Request::is('internals')?"active":"" }}"><a href="{{route('internals.index')}}">Internal</a></li>
          ...
          <li class="dropdown">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Reports <span class="caret"></span></a>
              <ul class="dropdown-menu">
                ...
                <li><a href="{{route('reports.registration')}}">Registration</a></li>
                <li><a href="{{route('reports.internal')}}">Internal</a></li>
                <li><a href="{{route('reports.result')}}">Result</a></li>
              </ul>
          </li>
